...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            // 'RouteWithSubRoutes': path.resolve(__dirname, 'client/components/RouteWithSubRoutes'),
            // 'toJS': path.resolve(__dirname, 'client/components/HOC/toJS')
        },
    ...
    plugins: [
        ...
        new FaviconsWebpackPlugin({
            logo: __DEV__ ? join(config.projectRoot, './client/assets/img/logo_300x300.png') : join(config.projectRoot, './client/assets/img/logo_600x600.png'),
